...
public class AddCommentTest extends RefactoringTest {
    ...
    public void testThrows() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new AddComment(null, null, "Random comment"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new AddComment(null, "__init__", null));
    }
