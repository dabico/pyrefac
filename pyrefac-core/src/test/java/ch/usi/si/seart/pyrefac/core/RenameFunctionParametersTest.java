...
public class RenameFunctionParametersTest extends RefactoringTest {
    ...
    private static Stream<Arguments> executables() {
        return Stream.of(
                Arguments.of((Executable) () -> new RenameFunctionParameters(null, null, "old_name", "new_name")),
                Arguments.of((Executable) () -> new RenameFunctionParameters(null, "__init__", null, "new_name")),
                Arguments.of((Executable) () -> new RenameFunctionParameters(null, "__init__", "old_name", null))
        );
    }
